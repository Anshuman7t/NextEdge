...
# List of Oceania countries to scrape
oceania_countries = ['American Samoa','Australia','Cook Islands','Fiji',
                    'Guam','Marshall Islands','Micronesia','Nauru','New Caledonia',
                    'New Zealand','Northern-Mariana-Islands','Palau','Papua-New-Guinea','Samoa',
                    'Solomon Islands','Tonga','Tahiti','Vanuatu']
    ...
    with ThreadPoolExecutor(max_workers=1) as executor:  # Single worker for debugging
        ...
        for country in oceania_countries:
            for gender in ['men', 'women']:
                base_url = 'https://www.australiabasket.com'
                process_country(country, gender, base_url, 'basketball.australiabasket.com')
