...
europe_countries = ['Albania','Armenia','Austria','Azerbaijan','Belarus','Belgium','Bosnia','Bulgaria','Croatia','Cyprus',
                    'Czech-Republic','Denmark','Estonia','Finland','France','Georgia','Germany','Greece','Holland','Hungary','Iceland',
                    'Ireland','Israel','Italy','Kosovo','Latvia','Lithuania','Luxembourg','Malta','Moldova','Montenegro','North-Macedonia',
                    'Norway','Poland','Portugal','Romania','Russia','Scotland','Serbia','Slovakia','Slovenia','Spain','Sweden',
...
async def start_scraping():
    ...
    with ThreadPoolExecutor(max_workers=1) as executor:  # Single worker for debugging
        # Process Europe (men and women)
        for country in europe_countries:
            for gender in ['men', 'women']:
                base_url = 'https://basketball.eurobasket.com'
                process_country(country, gender, base_url, 'basketball.eurobasket.com')
